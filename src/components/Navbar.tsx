      ...
      <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-slate-900/80 backdrop-blur-md px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <a href="#ecosystem" className="text-sm font-medium text-white/80 transition-colors hover:text-white">
              Ecosystem
            </a>
            <a href="/vision-2035" className="text-sm font-medium text-white/80 transition-colors hover:text-white">
              Vision 2035
            </a>
